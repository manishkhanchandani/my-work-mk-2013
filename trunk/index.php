...
<div id="northContent"><h1>My World</h1><div id="menuDiv"><div id="innerDiv"></div><div id="rightDiv"></div></div></div>
<div id="center">
...
paneCenter.addContent( new DHTMLSuite.paneSplitterContentModel( { id: 'center',htmlElementId:'center',title:'My World',tabTitle: 'My World',closable:false } ) );
...
<ul id="menuModel" style="display:none">
	...
	<li id="500011"><a href="#">Modules</a>
		<ul width="150">
			...
			<li id="5000110" jsFunction="openPage('center', 'change_city', 'change/city', 'Change City', 'Change City')"><a href="#">Change City</a></li>
